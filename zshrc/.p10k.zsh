# Generated by Powerlevel10k configuration wizard on 2026-06-29 at 19:04 CST.
...
() {
  ...
  # Mocha Cyan background
  # typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND='#94E2D5'
  ...
  # typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND='#F38BA8'
  # typeset -g POWERLEVEL9K_VCS_FOREGROUND='#1E1E2E'
...
#source ~/.config/zsh/themes/catppuccin/.p10k-classic-catppuccin-mocha.zsh
source ~/.config/zsh/themes/catppuccin/.p10k-rainbow-catppuccin-mocha.zsh
#
#
